...
def get_resto_data(resto):
    ...
    col_map = {'name': 'restaurant', 'total_mean' : 'average rating', 'total_slope': 'average trend in rating','div3_food_quality': 'food quality ', 'div3_menu': 'offerings ', 'div3_service' : 'service ', 'div3_value': 'value ', 'probs' : 'Michelin 2020 Security' }
...
def plot_resto_scatter_by_feat(feat1, feat2, resto):
    ...
    my_map = {'name': 'restaurant', 'total_mean' : 'average rating', 'total_slope': 'average trend in rating','div3_food_quality': 'food quality ', 'div3_menu': 'offerings ', 'div3_service' : 'service ', 'div3_value': 'value ', 'probs' : 'Michelin 2020 Security' }
    ...
    style_data_conditional=[
        {
            'if': {
                ...
                'filter_query': '{Michelin 2020 Security} < 0'
            },
